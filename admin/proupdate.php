          ...
          <h1>Products</h1>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="file" id="picture" name="file" href="">
                  <!-- <input type="file" id="picture" name="file1" value="    " hidden> -->
                </div>
                <div class="form-group">
                  <label for="description">Description</label>
                  <textarea id="description" class="form-control" rows="10" placeholder="Enter Description" value="<?php echo $final['description'] ?>" name="description"> <?php echo $final['description'] ?></textarea>
                </div>
                <div class="form-group">
